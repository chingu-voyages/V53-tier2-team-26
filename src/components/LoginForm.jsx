    ...
    function handleSignIn(e){
        ...
        return (
         ...
         <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            {!signedIn && <><div className="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
              <form className="space-y-6" action="#" method="POST" onSubmit={(e) => handleSignIn(e)}>
                <div>
                  ...
                  <div className="mt-2">
                    <input type="email" name="email" id="email" autoComplete="email" required className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 sm:text-sm/6" onChange={(e)=> setEmail(e.target.value)}/>
                  </div>
                </div>
